...
`${GOPATH}/src/github.com/davdjl/timebeat`
...
```
git remote set-url origin https://github.com/davdjl/timebeat
...
in the same directory with the name timebeat.
...
```
mkdir -p ${GOPATH}/src/github.com/davdjl/timebeat
git clone https://github.com/davdjl/timebeat ${GOPATH}/src/github.com/davdjl/timebeat
```
